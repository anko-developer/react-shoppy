...
export default function ProductCard({product, product: { id, image, title, category, price }}) {
  ...
  return (
    <li onClick={() => navigate(`/products/${id}`, { state: {product} })} className='flex flex-col rounded-lg shadow-md overflow-hidden cursor-pointer transition-all hover:scale-105'>
